...
impl api::PaymentAuthorize for Wave {}
...
impl<Flow, Request, Response> ConnectorCommonExt<Flow, Request, Response> for Wave
where
...
impl ConnectorCommon for Wave {
    ...
    fn base_url<'a>(&self, connectors: &'a Connectors) -> &'a str {
        connectors.wave.base_url.as_ref()
    }
    ...
    fn build_error_response(
        ...
        let response: wave::WaveErrorResponse = res
            .response
            .parse_struct("WaveErrorResponse")
...
impl ConnectorIntegration<AccessTokenAuth, AccessTokenRequestData, AccessToken> for Wave {}
...
impl ConnectorIntegration<Authorize, PaymentsAuthorizeData, PaymentsResponseData> for Wave {
    ...
    fn get_request_body(
        ...
        let connector_router_data = wave::WaveRouterData::from((amount, req));
        let connector_req = wave::WavePaymentsRequest::try_from(&connector_router_data)?;
    ...
    fn handle_response(
        ...
        let response: wave::WavePaymentsResponse = res
            .response
            .parse_struct("Wave PaymentsAuthorizeResponse")
            .change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
        event_builder.map(|i| i.set_response_body(&response));
        router_env::logger::info!(connector_response=?response);
...
impl ConnectorIntegration<PSync, PaymentsSyncData, PaymentsResponseData> for Wave {
    ...
    fn handle_response(
        ...
        let response: wave::WavePaymentsResponse = res
            .response
            .parse_struct("wave PaymentsSyncResponse")
            .change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
        event_builder.map(|i| i.set_response_body(&response));
        router_env::logger::info!(connector_response=?response);
        RouterData::try_from(ResponseRouterData {
...
impl ConnectorIntegration<Capture, PaymentsCaptureData, PaymentsResponseData> for Wave {
    ...
    fn handle_response(
        ...
        let response: wave::WavePaymentsResponse = res
            .response
            .parse_struct("Wave PaymentsCaptureResponse")
            .change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
        event_builder.map(|i| i.set_response_body(&response));
        router_env::logger::info!(connector_response=?response);
        RouterData::try_from(ResponseRouterData {
...
impl ConnectorIntegration<Execute, RefundsData, RefundsResponseData> for Wave {
    ...
    fn get_request_body(
        ...
        let connector_router_data = wave::WaveRouterData::from((refund_amount, req));
    ...
    fn handle_response(
        ...
        let response: wave::RefundResponse = res
            .response
            .parse_struct("wave RefundResponse")
            .change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
        event_builder.map(|i| i.set_response_body(&response));
        router_env::logger::info!(connector_response=?response);
        RouterData::try_from(ResponseRouterData {
...
impl ConnectorIntegration<RSync, RefundsData, RefundsResponseData> for Wave {
    ...
    fn handle_response(
        ...
        let response: wave::RefundResponse =
            res.response
                .parse_struct("wave RefundSyncResponse")
                .change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
        event_builder.map(|i| i.set_response_body(&response));
        router_env::logger::info!(connector_response=?response);
        RouterData::try_from(ResponseRouterData {
...
impl webhooks::IncomingWebhook for Wave {
...
static WAVE_SUPPORTED_PAYMENT_METHODS: LazyLock<SupportedPaymentMethods> =
    LazyLock::new(SupportedPaymentMethods::new);

static WAVE_CONNECTOR_INFO: ConnectorInfo = ConnectorInfo {
    display_name: "Wave",
    description: "Wave connector",
    connector_type: enums::HyperswitchConnectorCategory::PaymentGateway,
};

static WAVE_SUPPORTED_WEBHOOK_FLOWS: [enums::EventClass; 0] = [];

impl ConnectorSpecifications for Wave {
    fn get_connector_about(&self) -> Option<&'static ConnectorInfo> {
        Some(&WAVE_CONNECTOR_INFO)
    }
    ...
    fn get_supported_webhook_flows(&self) -> Option<&'static [enums::EventClass]> {
        Some(&WAVE_SUPPORTED_WEBHOOK_FLOWS)
    }
}
